Insert into Bridge (member1 ,member2)       --fill the bridge table with the pilots
select Pilot1Init ,Pilot2Init from Flight_T2;

Insert into Flight (                        --fill the flight table with the data from Flight_T2 and the group.id of the bridge table
	PlaneRegistration,
	groupid,
	Launchtime ,
	Landingtime ,
	...
	LaunchMethod,
	club_id )
Select PlaneRegistration, Bridge.id, Launchtime, Landingtime, cablebreak, crosscountrykm , LAUNCHMETHOD,c_id from Flight_T2
join Bridge 
